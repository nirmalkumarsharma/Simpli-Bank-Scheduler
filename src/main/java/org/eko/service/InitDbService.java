...
public class InitDbService {
	...
	public void initFunction() throws SchedulerException
	{
		...
		simpliJob1.setStartTime(new GregorianCalendar(2017, 6, 13, 19, 57, 6));
		simpliJob1.setEndTime(new GregorianCalendar(2017, 6, 13, 19, 57, 9));
		...
		simpliJob2.setStartTime(new GregorianCalendar(2017, 6, 13, 19, 57, 7));
		simpliJob2.setEndTime(new GregorianCalendar(2017, 6, 13, 19, 57, 10));
		...
		simpliJob3.setStartTime(new GregorianCalendar(2017, 6, 13, 19, 57, 8));
		simpliJob3.setEndTime(new GregorianCalendar(2017, 6, 13, 19, 57, 11));
		...
		simpliJob4.setStartTime(new GregorianCalendar(2017, 6, 13, 19, 57, 9));
		simpliJob4.setEndTime(new GregorianCalendar(2017, 6, 13, 19, 57, 12));
