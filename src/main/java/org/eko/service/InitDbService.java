...
public class InitDbService {
	...
	public void init() throws SchedulerException
	{
		...
		if(simpliJob2==null)
		{
			...
			simpliJob2.setStartTime(new GregorianCalendar(2017, 5, 14, 11, 27, 7));
			simpliJob2.setEndTime(new GregorianCalendar(2017, 5, 14, 11, 27, 10));
		...
		if(simpliJob3==null)
		{
			...
			simpliJob3.setStartTime(new GregorianCalendar(2017, 5, 14, 11, 27, 8));
			simpliJob3.setEndTime(new GregorianCalendar(2017, 5, 14, 11, 27, 11));
		...
		if(simpliJob4==null)
		{
			...
			simpliJob4.setStartTime(new GregorianCalendar(2017, 5, 14, 11, 27, 9));
			simpliJob4.setEndTime(new GregorianCalendar(2017, 5, 14, 11, 27, 12));
